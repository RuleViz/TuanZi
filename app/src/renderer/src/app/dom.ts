...
export const contextPanelTasks = byId<HTMLDivElement>("contextPanelTasks");
export const contextPanelFiles = byId<HTMLDivElement>("contextPanelFiles");
export const contextTasksToggle = byId<HTMLButtonElement>("contextTasksToggle");
export const contextFilesToggle = byId<HTMLButtonElement>("contextFilesToggle");
export const contextTasksBody = byId<HTMLDivElement>("contextTasksBody");
export const contextFilesBody = byId<HTMLDivElement>("contextFilesBody");
export const contextTasksCount = byId<HTMLSpanElement>("contextTasksCount");
export const contextFilesCount = byId<HTMLSpanElement>("contextFilesCount");
