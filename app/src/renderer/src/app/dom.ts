...
export const toggleWorkbench = byId<HTMLButtonElement>("toggleWorkbench");
export const sidebar = byId<HTMLElement>("sidebar");
export const workbenchDrawer = byId<HTMLElement>("workbenchDrawer");
export const closeWorkbenchBtn = byId<HTMLButtonElement>("closeWorkbenchBtn");
export const workbenchPageTasksBtn = byId<HTMLButtonElement>("workbenchPageTasksBtn");
export const workbenchPageTerminalsBtn = byId<HTMLButtonElement>("workbenchPageTerminalsBtn");
export const workbenchPageFilesBtn = byId<HTMLButtonElement>("workbenchPageFilesBtn");
export const workbenchTasks = byId<HTMLDivElement>("workbenchTasks");
export const workbenchTasksCount = byId<HTMLSpanElement>("workbenchTasksCount");
export const workbenchTerminalsCount = byId<HTMLSpanElement>("workbenchTerminalsCount");
export const workbenchFilesCount = byId<HTMLSpanElement>("workbenchFilesCount");
export const workbenchFiles = byId<HTMLDivElement>("workbenchFiles");
export const newWorkbenchTerminalBtn = byId<HTMLButtonElement>("newWorkbenchTerminalBtn");
export const workbenchTerminalTabs = byId<HTMLDivElement>("workbenchTerminalTabs");
export const workbenchTerminalPanel = byId<HTMLDivElement>("workbenchTerminalPanel");
